...
// Sample of the most recently imported scratch image (GPU read-back): is the
// encoder fed real pixels or zeros? Never null.
const char* alvr_vk_encoder_submit_diag();
